...
; loop_create_mines:
	...
	; sub eax, ecx
	; cmp eax, 0
	; jl loop_create_mines
; imparte_100:
	; mov ecx, 100
	; div ecx
	; jg imparte_100
	; cmp matrix[eax], 9
	; je loop_create_mines
	; mov matrix[eax], 9
	; inc ebx
	; cmp ebx, 9
	; jle loop_create_mines
...
scriere_mesaj:
	...
	make_text_macro 'X', area, 210, 410
	linie_orizontala 221, 420, 8, 80FC38h
	make_text_macro 'M', area, 230, 410
	make_text_macro 'I', area, 240, 410
	make_text_macro 'N', area, 250, 410
	make_text_macro 'E', area, 260, 410
